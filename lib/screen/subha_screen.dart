              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: const Color(0xff06513E).withOpacity(0.5),
                    ),
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            toArabicNumbers('1,254'),
                            // you can format totalTsbeeh here
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                      ...
                      Column(
                        mainAxisSize: MainAxisSize.min,
                        children: const [
                          // Using a similar icon to home, since we don't have the custom SVG
                          Icon(Icons.mosque_outlined, color: Color(0xffD4AF37)),
                          SizedBox(height: 4),
                          Text(
                            'الرئيسية',
                            style: TextStyle(
